...
if(document.addEventListener ){ 
   ...
   aLoader = [
      ...
      { load: "develop/develop-NO-OPEN.js", user: true },
      { load: "index_edge.js"},
...
var plSTF="both",ctrPlS="both",minPlW="0",maxPlW=undefined,plWidth="1000px",plHeight="656px";
...
preContent={
    dom: [
    {
        ...
        type: 'image',
        tag: 'img',
        rect: ['184px', '249px','632px','157px','auto', 'auto'],
        fill: ["rgba(0,0,0,0)",'images/edge/precarga.gif','0px','0px']
    }]};//simpleContent
